...
Record selected tune to an AU file. Works like I<-w>.
...
Due to Copyright laws, C64play doesn't ship with ROM dumps. Check
L<c64play.ini> for more details like search paths and configuration
stuff.
